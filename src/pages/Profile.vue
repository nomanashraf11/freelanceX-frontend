<template>
  <default-layout>
    <div class="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div
        class="max-w-lg w-full space-y-8 bg-white p-8 rounded-xl shadow-2xl transform transition-all hover:scale-105"
      >
        <div>
          <h1 class="text-center text-3xl font-extrabold text-gray-900">Your Profile</h1>
          <p class="mt-2 text-center text-sm text-gray-600">View and manage your personal information</p>
        </div>
